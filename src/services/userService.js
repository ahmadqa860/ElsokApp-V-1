...
export async function addProduct(
  {imagesArray, categorie_id, product_title, product_description,product_price,device}
) {  
  ...
  imagesArray.forEach( (photo,index) => {
    bodyFormData.append('uploadImages'+index, {
      name: photo.fileName,
      type: photo.type,
      uri: photo.uri,
    })
  ...
  bodyFormData.append('imagesNumber', imagesArray.length);
